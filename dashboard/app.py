...
async def read_dashboard(request: Request):
    ...
    if is_india:
        ...
        venue_subtitle = "Currency: USD ($) • MetaTrader 5 Multi-Asset Bridge • 24/5 Interbank FX & Gold Spot"
        broker_badge = '<i class="fa-solid fa-chart-line mr-1"></i>MT5: FOREX & GOLD LIVE ACTIVE'
        hdr_env_label = f"METATRADER 5 ({eq_str})"
